...
async function init() {
    ...
    if (users && users.length > 0) {
        ...
        // New user — assign role based on tab
        // Block Google signup for super_admin
...
require('fs').writeFileSync('platform/auth-callback.html', callback);
console.log('auth-callback.html updated!');