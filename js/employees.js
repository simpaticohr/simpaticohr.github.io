  ...
  if (content) {
    ...
    <div id="tab-overview">
        ...
        <div class="hr-card">
          ...
          <div style="display:flex;align-items:center;gap:20px">
            ...
            <div>
              ...
              <a href="performance.html?employee=${emp.id}" class="hr-btn hr-btn-ghost hr-btn-sm" style="margin-top:10px">View all reviews</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="hr-card" style="margin-top:20px">
        <div class="hr-card-head"><h3>Training Progress</h3><a href="training.html?employee=${emp.id}" class="hr-btn hr-btn-ghost hr-btn-sm">View all</a></div>
